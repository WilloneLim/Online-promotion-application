...
<!--        <button class="dropdown-btn">Dropdown </button>-->
  ...
  <div class="contentA isOpen">
    ...
    <a href="charts.php" class="col-md-3 btn btn-warning btn-lg btn-block py-5 font-weight-bolder">Promoters</a>
    <a href="viewapplicationsadmin.php" class="col-md-3 btn btn-warning mx-5 btn-lg btn-block py-5 font-weight-bolder">Applications</a>
    <a href="charts.php" class="col-md-3 btn btn-warning btn-lg btn-block py-5 font-weight-bolder">Transactions</a>
